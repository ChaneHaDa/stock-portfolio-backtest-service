...
public class CalculatorService {
    ...
    public CalculatorRorReturnDTO calculateRor(CalculatorRorInputDTO calculatorRorInputDTO) {
        ...
        long profit = (long) ((calculatorRorInputDTO.getSellPrice() - calculatorRorInputDTO.getBuyPrice())
                * calculatorRorInputDTO.getQuantity());
    ...
    public CalculatorWelfareReturnDTO calculateWelfare(CalculatorWelfareInputDTO calculatorWelfareInputDTO) {
        List<Double> rorList = RorCalculator.getWelfareRorList(calculatorWelfareInputDTO.getRor(),
                calculatorWelfareInputDTO.getTerm());
